...
public class PersonController {
    ...
    public ModelAndView list() {
        ModelAndView mav = new ModelAndView("all/person/list");
    ...
    public ModelAndView create() {
        ...
        ModelAndView mav = new ModelAndView("all/person/create");
    ...
    public ModelAndView create(Person person) {
        ...
        if (errors.isEmpty()) {
            ...
            return new ModelAndView("redirect:/all/person/list");
        } else {
            ModelAndView mav = new ModelAndView("all/person/create");
    ...
    public ModelAndView edit(@PathVariable Integer personId) {
        List<Client> clients = clientService.listClient();
        ModelAndView mav = new ModelAndView("all/person/edit");
    ...
    public ModelAndView delete(@PathVariable Integer personId) {
        ModelAndView mav = new ModelAndView("all/person/delete");
        mav.addObject("person", personService.readPerson(personId));
        return mav;
    }
    ...
    public String delete(@RequestParam String command, @RequestParam Integer personId) {
        ...
        return "redirect:/all/person/list";
    }
}
